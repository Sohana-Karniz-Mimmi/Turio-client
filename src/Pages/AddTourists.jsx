                ...
                <form onSubmit={handleSubmit(handleSubmitForm)} className="container mx-auto flex justify-center space-y-12">
                    <fieldset className=" py-10 md:px-16 px-5 rounded-md shadow-sm dark:bg-white border-2 mt-5">
                        <div className="mb-6 text-center">
                            <h3 className="md:text-4xl text-2xl font-extrabold">Add Tourists Spot</h3>
                        </div>
                        <div className=" md:w-[680px] w-[300px] grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                            ...
                            <div className="col-span-full sm:col-span-3">
                                ...
                                <div className="relative">
                                    <input {...register("touristsSpotName", { required: true })} name="touristsSpotName" required type="text" className="w-full text-base border rounded-lg border-gray-300 focus:border-[#333] px-2 py-2 outline-none bg-transparent" placeholder="Enter as Tourists Spot Name" />
                            ...
                            <div className="col-span-full sm:col-span-3">
                                ...
                                <div className="relative">
                                    <select {...register("countryName", { required: true })} name="countryName" type="text" required className="w-full text-base border rounded-lg border-gray-300 focus:border-[#333] px-2 py-2 outline-none bg-transparent">
                            ...
                            <div className="col-span-full sm:col-span-3">
                                ...
                                <div className="relative">
                                    <input {...register("location", { required: true })} name="location" type="text" required className="w-full text-base border rounded-lg border-gray-300 focus:border-[#333] px-2 py-2 outline-none bg-transparent" placeholder="Enter Your Photo URL" />
                            ...
                            <div className="col-span-full sm:col-span-3">
                                ...
                                <div className="relative">
                                    <input {...register("photo", { required: true })} name="photo" required type="text" className="w-full text-base border rounded-lg border-gray-300 focus:border-[#333] px-2 py-2 outline-none bg-transparent" placeholder="Enter Your Photo URL" />
                            ...
                            <div className="col-span-full sm:col-span-3">
                                ...
                                <div className="relative">
                                    <input {...register("averageCost", { required: true })} name="averageCost" type="text" required className="w-full text-base border rounded-lg border-gray-300 focus:border-[#333] px-2 py-2 outline-none bg-transparent" placeholder="Enter Average Cost" />
                            ...
                            <div className="col-span-full sm:col-span-3">
                                ...
                                <div className="relative">
                                    <select {...register("seasonality", { required: true })} type="text" required className="w-full text-base border rounded-lg border-gray-300 focus:border-[#333] px-2 py-2 outline-none bg-transparent">
                            ...
                            <div className="col-span-full sm:col-span-3">
                                ...
                                <div className="travelTime">
                                    <input {...register("travelTime", { required: true })} name="travelTime" type="text" required className="w-full text-base border rounded-lg border-gray-300 focus:border-[#333] px-2 py-2 outline-none bg-transparent" placeholder="Enter Your Photo URL" />
                            ...
                            <div className="col-span-full sm:col-span-3">
                                ...
                                <div className="relative">
                                    <input {...register("totalVisitors", { required: true })} name="totalVisitors" type="text" required className="w-full text-base border rounded-lg border-gray-300 focus:border-[#333] px-2 py-2 outline-none bg-transparent" placeholder="Enter Your Photo URL" />
                            ...
                            {/* Btn */}
                            <div className="col-span-full">
                                <input type="submit" value='Add Tourists Spot' className="w-full text-lg p-2 rounded-md btn bg-green-600 hover:bg-green-600 text-white" />
                            </div>
                        </div>
                    </fieldset>
                </form>
