            ...
            <section className="barlow-condensed-regular pt-20 pb-10 lg:pt-20 lg:pb-20 dark:bg-dark">
                <div className="container mx-auto">
                    ...
                    <div className="-mx-4 flex flex-wrap justify-center">
                        <div data-aos="fade-up" data-aos-duration="1000" className="w-full px-4 md:w-1/2 xl:w-1/4">
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" className="w-full px-4 md:w-1/2 xl:w-1/4">
                            <div className="mx-auto mb-10 w-full max-w-[370px]">
                                <div className="relative overflow-hidden rounded-lg">
                                    <img
                                        src={team2}
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="700" className="w-full px-4 md:w-1/2 xl:w-1/4">
                            <div className="mx-auto mb-10 w-full max-w-[370px]">
                                <div className="relative overflow-hidden rounded-lg">
                                    <img
                                        src={team3}
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="900" className="w-full px-4 md:w-1/2 xl:w-1/4">
                            <div className="mx-auto mb-10 w-full max-w-[370px]">
                                <div className="relative overflow-hidden rounded-lg">
                                    <img
                                        src={team4}
